...
{
    public class Endereco_VagasController : Controller
    {
        private readonly AppDbContext _context;

        public Endereco_VagasController(AppDbContext context)
        {
            _context = context;
        }
